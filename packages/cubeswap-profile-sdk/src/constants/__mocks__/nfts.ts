...
export const nftSources: NftSource = {
  ...
  [NftType.MIXIE]: {
    address: {
      1818: "0xa251b5EAa9E67F2Bc8b33F33e20E91552Bf85566",
      1819: "",
    },
...
const Nfts: Nft[] = [
  {
    name: "Mixie v1",
    description: "Stories were told, and songs were sung, about Chef Mixie’s cubeswaps and her big Syrup gun.",
    images: {
      lg: "mixie-1-lg.png",
      md: "mixie-1-md.png",
      sm: "mixie-1-sm.png",
  ...
  },
  {
    ...
    sortOrder: 999,
    identifier: "sleepy",
    type: NftType.CUBESWAP,
    variationId: 5,
  },
  {
    name: "Swapsies",
    description: "These bunnies love nothing more than swapping cubeswaps. Especially on CUBE.",
    images: {
      lg: "swapsies-lg.png",
      md: "swapsies-md.png",
      sm: "swapsies-sm.png",
