...
import chaoticCsersSm from "./teams/chaotic-csers-sm.png";
import chaoticCsersMd from "./teams/chaotic-csers-md.png";
import chaoticCsersLg from "./teams/chaotic-csers-lg.png";
import chaoticCsersAlt from "./teams/chaotic-csers-alt.png";
import chaoticCsersBg from "./teams/chaotic-csers-bg.svg";
...
const teamImages: ImageMap = {
  ...
  "chaotic-csers-sm.png": chaoticCsersSm,
  "chaotic-csers-md.png": chaoticCsersMd,
  "chaotic-csers-lg.png": chaoticCsersLg,
  "chaotic-csers-alt.png": chaoticCsersAlt,
  "chaotic-csers-bg.svg": chaoticCsersBg,
};
