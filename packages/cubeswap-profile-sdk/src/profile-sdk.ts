...
class CubeswapProfileSdk {
   ...
   * API repo - https://github.com/Cubeswap-exchange/cubeswap-profile-api
   */
   ...
   * Contract repo - https://github.com/Cubeswap-exchange/cubeswap-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from CubeswapProfile contract.
   * NFT's bunnyId is retrieved from CubeswapBunnies contract and mapped to static NFT data stored in constant.
   * Contracts repo - https://github.com/Cubeswap-exchange/cubeswap-contracts/tree/master/projects/profile-nft-gamification
   */
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://cubeswap.exchange/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "cubeswap.finance", secure: true, expires: 30 }
        );
      }
