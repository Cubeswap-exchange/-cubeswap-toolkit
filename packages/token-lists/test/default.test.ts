...
import currentCubeswapDefaultList from "../lists/cubeswap-default.json";
import currentCubeswapExtendedtList from "../lists/cubeswap-extended.json";
import currentCubeswapTop15List from "../lists/cubeswap-top-15.json";
import currentCubeswapTop100tList from "../lists/cubeswap-top-100.json";
import currentCoingeckoList from "../lists/coingecko.json";
import currentCmcList from "../lists/cmc.json";
import currentCubeswapMiniList from "../lists/cubeswap-mini.json";
import currentCubeswapMiniExtendedList from "../lists/cubeswap-mini-extended.json";
import { buildList, VersionBump } from "../src/buildList";
import getTokenChainData from "../src/utils/getTokensChainData";

const currentLists = {
  "cubeswap-default": currentCubeswapDefaultList,
  "cubeswap-extended": currentCubeswapExtendedtList,
  "cubeswap-top-100": currentCubeswapTop100tList,
  "cubeswap-top-15": currentCubeswapTop15List,
  coingecko: currentCoingeckoList,
  cmc: currentCmcList,
  "cubeswap-mini": currentCubeswapMiniList,
  "cubeswap-mini-extended": currentCubeswapMiniExtendedList,
};
...
expect.extend({
  ...
  toBeValidLogo(token) {
    ...
    const refersToLocalLogo = token.logoURI === `https://tokens.cubeswap.finance/images/${token.address}.png`;
